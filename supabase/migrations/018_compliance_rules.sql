-- Synchronise en ligne les règles de discipline (module Compliance / RuleBuilder),
-- jusque-là stockées uniquement en localStorage. Stockées en JSONB dans
-- user_preferences (même table que les 3 listes Bias / Règles / Erreurs).
...
ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS compliance_rules JSONB;

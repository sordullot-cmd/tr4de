-- Ajoute les colonnes timezone et base_currency à user_preferences
-- (la table peut déjà exister via la migration 015).
...
ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS base_currency TEXT;

        ...
        {selectedTrade && (
          <div style={{width:360,maxHeight:"calc(100vh - 200px)",background:T.white,border:`1px solid ${T.border}`,borderRadius:12,display:"flex",flexDirection:"column",overflow:"hidden"}}>
            ...
            <div style={{flex:1,overflow:"auto",display:"flex",flexDirection:"column"}}>
              ...
              {activeTab === "infos" && (
                <>
                  {/* INFO ROWS group : pas de séparateurs internes, juste un bord en bas */}
                  <div style={{padding:"6px 16px 10px",borderBottom:`1px solid ${T.border}`,fontFamily:"var(--font-sans)"}}>
